...
elseif (false === $has_data): 
	...
	<?php else: ?>
        ...
        <a class='button button-secondary' title="Generate the alternative text with ShortPixel AI (Beta)" href="javascript:window.ShortPixelProcessor.screen.RequestAlt(<?php echo $item_id ?>)">
			...
			<span><?php printf(__('Ai by ShortPixel data generated: %s', 'shortpixel-image-optimiser'), $dataItems) ?></span>
...
?>
	...
	<p><img class="shortpixel-ai-caption shortpixel-ai-icon shortpixel" src="<?php echo $robo_icon ?>"> <?php printf(__('Ai by ShortPixel Data Generated: %s', 'shortpixel-image-optimiser'), '<strong>' . $dataItems . '</strong>') ?></p>
	
	<a class='button button-secondary' title="<?php _e('Restores the previous ALT tag, if available.', 'shortpixel-image-optimiser'); ?>" href="javascript:window.ShortPixelProcessor.screen.UndoAlt(<?php echo $item_id ?>, 'undo')"><?php _e('Undo', 'shortpixel-image-optimiser'); ?></a>
	...
	<a class='button button-secondary' title="<?php _e('Report to us, via e-mail, an incorrect ALT tag for this image', 'shortpixel-image-optimiser') ?>." href="<?php echo $mailtolink ?>"><?php _e('Report', 'shortpixel-image-optimiser'); ?></a>

...
if (false === $has_data): 
	...
	?>
	<p><?php _e('Quota exhausted, the ALT tag cannot be generated.', 'shortpixel-image-optimiser'); ?></p>
...
?>
	...
	<a class='button button-secondary' title="Send us feedback about this feature, suggest other features, or vote on existing feature requests." target="_blank" href="https://shortpixel.upvotyfeedback.com/"><?php _e('Feedback', 'shortpixel-image-optimiser'); ?></a>

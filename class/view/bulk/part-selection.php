			 ...
			 <div class='ai-images optiongroup'>
				...
				<label>
				 ...
				 <div class='ai_content_replace_inline'>
					<label for="ai_content_replace_select"><?php esc_html_e('When writing to posts:', 'shortpixel-image-optimiser'); ?></label>
					<select id="ai_content_replace_select" name="ai_content_replace_select">
						<option value="none" <?php selected(\wpSPIO()->settings()->ai_content_replace, 'none'); ?>><?php esc_html_e("Don't modify post content", 'shortpixel-image-optimiser'); ?></option>
						<option value="missing" <?php selected(\wpSPIO()->settings()->ai_content_replace, 'missing'); ?>><?php esc_html_e('Fill only where alt is missing', 'shortpixel-image-optimiser'); ?></option>
						<option value="overwrite" <?php selected(\wpSPIO()->settings()->ai_content_replace, 'overwrite'); ?>><?php esc_html_e('Overwrite existing alt/caption', 'shortpixel-image-optimiser'); ?></option>
					</select>
				 </div>

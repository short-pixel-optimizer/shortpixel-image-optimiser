  ...
  <h3 class='heading'>
	...
	<div class='bulk-special-wrapper'>
	  ...
	  <p><?php printf(__('By starting the %s bulk restore %s process, the plugin will try to restore %s all images %s to the original state. All images will become unoptimized.', 'shortpixel-image-optimiser'), '<b>', '</b>', '<b>', '</b>'); ?></p>
				...
				<p class='warning'><?php _e('It is strongly adviced to create a backup.', 'shortpixel-image-optimiser'); ?></p>
...
<section class='panel bulk-migrate' data-panel="bulk-migrate"  >
  <h3 class='heading'>
	...
	<div class='bulk-special-wrapper'>
	  ...
	  <p><?php printf(__('By starting the %s bulk migrate %s process, the plugin will try to migrate %s all images %s . It is possible exceptions occur and some of the migration might fail.', 'shortpixel-image-optimiser'), '<b>', '</b>', '<b>', '</b>'); ?></p>
